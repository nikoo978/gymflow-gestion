  ...
  return <div className="mx-auto max-w-5xl space-y-6">
    ...
    <section className="grid gap-5 md:grid-cols-2">
      <article className="panel">
        ...
        {!isCloud && <p className="mt-3 text-xs font-bold text-slate-500">Modo local: no se registra ninguna suscripción remota. Tus datos locales no se suben a Supabase.</p>}
